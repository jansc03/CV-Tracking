...
class KalmanFilter:
    ...
    def __init__(self,id):
        ...
        self.kf.processNoiseCov = np.eye(4,
                                         dtype=np.float32) * 1e-1  # Beispielwert für Q (kleiner Wert für hohe "Lernrate")

        # Messrauschkovarianzmatrix R - verringertes Vertrauen in die Messung (kleinerer Wert bedeutet mehr Vertrauen)
        self.kf.measurementNoiseCov = np.array([[1e-2, 0],  # Weniger Unsicherheit bei Messungen
